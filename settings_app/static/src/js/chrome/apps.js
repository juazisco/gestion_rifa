...
odoo.define('settings_app.AppsMenu', function (require) {
"use strict";
...
AppsMenu.include({
    ...
    _setBackgroundImage: function () {
        ...
        if (session.settings_app_background_blend_mode) {
        	this.$('.o-app-name').css({
        		"mix-blend-mode": session.settings_app_background_blend_mode,
        	});
        }
    },
    ...
    _searchMenus: function () {
        ...
        this.$search_results.html(QWeb.render("settings_app.MenuSearchResults", {
            results: results,
            widget: this,
        }));
    },
