...
odoo.define('settings_app.AppsBar', function (require) {
"use strict";
...
var AppsBar = Widget.extend({
	events: _.extend({}, Widget.prototype.events, {
        'mouseover .nav-link': '_onAppsMenuItemMouseOvered',        
        'click .nav-link': '_onAppsMenuItemClicked',
    }),
	template: "settings_app.AppsBarMenu",
    ...
    _onAppsMenuItemMouseOvered: function (ev) {
        var $target = $(ev.currentTarget);
        var actionID = $target.data('action-id');
        var menuID = $target.data('menu-id');
        var app = _.findWhere(this._apps, {
